...
public class State implements IState, IRouting {
	...
	private Map<Integer,Map<String,EventOutput>> outputs = new HashMap<>();
	...
	public void addListener(int id, String key, EventOutput os) {
		...
		Map<String,EventOutput> tempOutPut= new HashMap<>();
		tempOutPut.put(key,os);
		outputs.put(id,tempOutPut);
